...
# OUTPUTS- Michael    Jordan
#          John       Rosales
#          Mark       Guillen
#          KB         Tonel
MLB_team = [
    {'State':'Colorado', 'Team' : 'Rockies'},
    {'State':'Boston', 'Team': 'Red Sox'},
    {'State':'Minnesota', 'Team' : 'Twins'},
    {'State':'Milwaukee', 'Team' : 'Brewers'},
    {'State':'Seattle' , 'Team' : 'Mariners'}
] 
iterateDictionary2('Team', MLB_team)  
#OUTPUT- Rockies
#       Red Sox
#       Twins
#       Brewers
...
def printInfo(some_dict):
    for key in some_dict: #accessing key in dictionary
        print(len(some_dict[key]), key.upper()) # length of key and .upper()to covert to uppercase
        for val in some_dict[key]: # inner for loop to access values further in key
            print(val)
